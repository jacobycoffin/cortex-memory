...
mkdir -p "$TARGET"
for file in __init__.py __main__.py attribution.py cli.py cognition.py dashboard.py dashboard.html extraction.py retrieval.py security.py semantics.py store.py tooling.py vault.py plugin.yaml README.md LICENSE CHANGELOG.md; do
