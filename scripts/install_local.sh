...
mkdir -p "$TARGET"
for file in __init__.py __main__.py attribution.py autojudge.py benchmarking.py client.py cli.py cognition.py dashboard.py dashboard_auth.py dashboard.html evaluation.py favicon.svg favicon.ico apple-touch-icon.png extraction.py harness.py metacognition.py refinery.py research.py retrieval.py review_copilot.py security.py semantics.py sleep.py store.py tooling.py vault.py plugin.yaml README.md LICENSE CHANGELOG.md; do
