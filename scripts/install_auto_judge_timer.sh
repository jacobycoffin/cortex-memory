...
if [[ ! -f "$ENV_FILE" ]]; then
  umask 077
  {
    ...
    echo "CORTEX_BRAIN_MECHANICS_MODEL=\"${CORTEX_BRAIN_MECHANICS_MODEL:-}\""
    echo "CORTEX_BRAIN_MECHANICS_TIMEOUT_SECONDS=\"${CORTEX_BRAIN_MECHANICS_TIMEOUT_SECONDS:-}\""
    ...
    echo 'CORTEX_AUTO_JUDGE_CONSOLIDATE=false'
    echo 'CORTEX_AUTO_JUDGE_CONSOLIDATE_INTERVAL_HOURS=12'
    echo 'CORTEX_AUTO_JUDGE_PRUNE=false'
    echo 'CORTEX_AUTO_JUDGE_PRUNE_THRESHOLD=0.25'
    echo 'CORTEX_AUTO_JUDGE_PRUNE_MAX_PER_RUN=50'
    echo 'CORTEX_AUTO_JUDGE_RECONSOLIDATE=false'
    echo 'CORTEX_LABILITY_WINDOW_MINUTES=30'
    echo 'CORTEX_AUTO_JUDGE_SCHEMAS=false'
    echo 'CORTEX_AUTO_JUDGE_SCHEMA_MIN_CLUSTER=3'
    echo 'CORTEX_AUTO_JUDGE_TUNE_WEIGHTS=false'
    echo 'CORTEX_AUTO_JUDGE_WEIGHT_AUDIT_DAYS=7'
    echo 'CORTEX_ATTENTIONAL_LEARNING=false'
    echo 'CORTEX_ATTENTIONAL_DECAY_DAYS=30'
  } > "$ENV_FILE"
fi
chmod 600 "$ENV_FILE"
